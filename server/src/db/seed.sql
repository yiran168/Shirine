...
ON CONFLICT(key) DO NOTHING;
INSERT INTO site_configs (key, value, updated_at)
VALUES ('footer', '{"startYear":2026,"enableHtmlInject":false,"links":[]}', unixepoch())
ON CONFLICT(key) DO NOTHING;
INSERT INTO site_configs (key, value, updated_at)
...
ON CONFLICT(key) DO NOTHING;
INSERT INTO site_configs (key, value, updated_at)
VALUES ('devices', '[{"id":"macbook-pro-16","name":"MacBook Pro 16\"","brand":"Apple","category":"desk","status":"active","specs":"M3 Max / 64GB / 2TB","description":"Primary workstation for development, design, and heavy rendering workloads.","icon":"material-symbols:laptop-mac-rounded","featured":true,"year":"2024","link":"https://www.apple.com/macbook-pro/","enable":true},{"id":"iphone-16-pro","name":"iPhone 16 Pro","brand":"Apple","category":"mobile","status":"active","specs":"A18 Pro / 256GB / Natural Titanium","description":"Daily mobile device, mobile photography and communication.","icon":"material-symbols:smartphone-rounded","featured":true,"year":"2024","link":"https://www.apple.com/iphone/","enable":true}]', unixepoch())
ON CONFLICT(key) DO NOTHING;
INSERT INTO site_configs (key, value, updated_at)
VALUES ('skills', '[{"id":"astro","name":"Astro","category":"frontend","proficiency":95,"level":"expert","icon":"simple-icons:astro","description":"Content-first framework powering this blog","featured":true,"enable":true},{"id":"svelte","name":"Svelte","category":"frontend","proficiency":90,"level":"advanced","icon":"simple-icons:svelte","description":"Reactive UI components and admin dashboard","featured":true,"enable":true},{"id":"typescript","name":"TypeScript","category":"frontend","proficiency":92,"level":"expert","icon":"simple-icons:typescript","description":"Type-safe application development across full stack","featured":true,"enable":true},{"id":"cloudflare","name":"Cloudflare Pages & Workers","category":"backend","proficiency":90,"level":"advanced","icon":"simple-icons:cloudflare","description":"Edge computing, D1 database, and R2 object storage","featured":true,"enable":true}]', unixepoch())
ON CONFLICT(key) DO NOTHING;
INSERT INTO site_configs (key, value, updated_at)
VALUES ('timeline', '[{"title":"Shirine 开源发布","date":"2026.03","category":"milestone","subtitle":"从概念到全栈架构落地","location":"GitHub","description":"发布 Shirine 动态博客系统，整合 Material 3 Expressive 设计规范与 Cloudflare 全栈能力。","highlights":["实现 Cloudflare D1 + R2 原生动态架构","引入 AES-256-GCM 本地离线文章与相册加密系统","深度支持 20+ 种 Material 增强写作语法"],"tags":["Astro","Svelte","Cloudflare","M3E"],"icon":"material-symbols:rocket-launch-rounded","featured":true,"enable":true}]', unixepoch())
ON CONFLICT(key) DO NOTHING;
INSERT INTO site_configs (key, value, updated_at)
VALUES ('system', '{"turnstile":{"siteKey":"","secretKey":""},"live2d":{"guestEnable":true,"adminEnable":true,"model":"/pio/models/NOIR/noir.model3.json","lang":"zh_CN","quotes":["欢迎来到 Shirine！","今天也是美好的一天～","有什么想和我聊聊的吗？","看文章累了就伸个懒腰吧！","点击右下角按钮可以返回顶部哦～","我会一直在这里陪着你的！"],"models":[{"name":"NOIR (默认)","url":"/pio/models/NOIR/noir.model3.json"},{"name":"Hiyori","url":"https://fastly.jsdelivr.net/gh/evpt/live2d-models/hiyori/hiyori.model3.json"}]},"ai":{"apiUrl":"https://api.openai.com/v1","apiKey":"","model":"gpt-4o-mini"},"checkin_rule":{"enabled":true,"fixedPoints":10,"rewardRange":15}}', unixepoch())
ON CONFLICT(key) DO NOTHING;
