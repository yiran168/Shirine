# Live2D 看板娘集成 (Live2D Widget)

Shirine 集成了基于 **Mizuki** 与 **stevenjoezhang/live2d-widget** 打造的 **Pio 看板娘组件**。

---

## 一、架构设计：iframe 沙箱隔离

传统博客在全局引入 Live2D 看板娘时，经常遇到脚本污染、全局 CSS 冲突（如 Tailwind 类名覆盖）、Swup 页面无刷新跳转导致动画重复初始化等棘手问题。
