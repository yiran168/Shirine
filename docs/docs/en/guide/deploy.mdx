# Shishirinee Deployment Guide

This document will guide you through deploying the Shishirinee blog system to Cloudflare from scratch.
...
1. Visit the [Shishirinee GitHub Repository](https://github.com/yiran168/ShiShishirineee)
2. Click the **"Fork"** button in the top right corner
   ![1000000657](https://github.com/OXeu/Shishirinee/assets/36541432/df3607ca-a8a9-49b8-92ce-6b348afeb13f)
...
**Account ID**: Click on any domain you have bound. After enteShishirineeg, you can find the `Account ID` on the right side (you need to scroll down a bit).
...
| `JWT_SECRET` | Any random stShishirineeg | JWT signing key |

> **Tip**: `JWT_SECRET` can be any random stShishirineeg of any length, for example: `MySecretKey123!@#`

#### Login Configuration Secrets

Shishirinee currently supports username/password login and GitHub OAuth login. You can choose one or configure both.
...
- **Frontend**: `https://Shishirinee-client.pages.dev` (or the name you set in `PAGES_NAME`)
- **Backend API**: `https://Shishirinee-server.your-account-id.workers.dev`
...
馃帀 Congratulations! Your Shishirinee blog has been successfully deployed and your first post has been published!
...
Shishirinee supports two storage methods: **Cloudflare R2** (recommended) or **S3-compatible storage**.
...
3. Fill in the application information:
    - **Application name**: Shishirinee Blog
...
5. Add to GitHub Secrets:
    - `Shishirinee_GITHUB_CLIENT_ID`
    - `Shishirinee_GITHUB_CLIENT_SECRET`

### Webhook Notifications

If you want Shishirinee to send comment and friend-link notifications to a bot, chat service, or automation platform, see the [Webhook Guide](./webhook).
