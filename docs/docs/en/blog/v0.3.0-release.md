...
# Shirine v0.3.0-rc.1 Prerelease
...
- Streamlined server DTOs, system configuration, and UI specs
- The frontend no longer depends on Eden Treaty-style calls and instead uses a custom type-safe API client
- Development, deployment, database, and release tasks are grouped under the Shirine CLI
