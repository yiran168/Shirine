...
hero:
  ...
  actions:
    ...
    - theme: alt
      text: GitHub
      link: https://github.com/yiran168/Shirine
features:
  - title: 构建速度极快
    details: 30秒构建与部署
    icon: 🏃🏻
  ...
  - title: 标签
    ...
    icon: 🏷️
  - title: 全面测试
    details: 使用 Vitest 和 Bun 测试运行器实现完整测试覆盖
    icon: 🧪
  - title: 现代化 API 客户端
    details: 自定义 HTTP 客户端替代 Eden，提供更好的类型安全
    icon: 🔌
  - title: CI/CD 就绪
    details: GitHub Actions 工作流实现自动化测试和部署
    icon: 🚀
  - title: 国际化
