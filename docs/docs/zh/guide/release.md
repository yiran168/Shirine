...
本文档描述了 Shirine 项目的发布流程。

## 概述

Shirine 使用[语义化版本控制](https://semver.org/lang/zh-CN/)，并遵循结构化的发布工作流以确保稳定性和一致性。
...
- 🐛 报告问题：[GitHub Issues](https://github.com/yiran168/Shirine/issues)
- 💬 加入我们的社区讨论
