...
<article class="album-card">
	<a class="album-card__link m3-state-layer" href={url(`/albums/${album.id}/`)} aria-label={album.title}>
		<div class="album-card__cover">
			...
			{#if album.permissionType && album.permissionType !== "public"}
				<CoverLockOverlay
