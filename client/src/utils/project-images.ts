 ...
 * co-located covers) lives in `<project>/shirines/…`, which no theme-relative
 * glob can ever reach.
 *
 ...
 * no `shirines/` directory exists.
 */
const projectImages = import.meta.glob<ImageMetadata>(
	"/shirines/**/*.{png,jpg,jpeg,webp,avif,svg,gif}",
	{ import: "default" },
);
 ...
 * in package mode looks like `../shirines/content/posts/guide`. Joining it onto
