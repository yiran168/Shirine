...
Mermaid turns text descriptions in Markdown into diagrams. The examples below use Shirine's content workflow to demonstrate diagram types commonly used in technical articles and project notes.
