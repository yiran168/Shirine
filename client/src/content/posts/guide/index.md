...
image: "./cover.jpeg"
tags: ["Shirine", "Guide", "Markdown", "M3E", "Blogging"]
category: Guides
draft: false
---

Welcome to **Shirine** (白音) — an expressive, anime-inspired blog theme crafted around **Astro 7**, **Svelte 5**, and the **Material 3 Expressive (M3E)** design system.
